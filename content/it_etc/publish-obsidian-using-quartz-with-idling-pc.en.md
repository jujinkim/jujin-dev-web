...
The structure is such that when you write and sync an article in Obsidian from anywhere, the build and deployment process is automatically handled by a separate PC.
...
Because the content is copied to a deployment folder and processed there before being deployed, without directly touching the original Obsidian articles, the original articles are safe. Also, you can select a specific folder for deployment instead of deploying the entire Obsidian vault, as only the contents of the selected folder are processed.
...
If you have purchased a custom domain, you can [configure](https://docs.github.com/en/pages/configuring-a-custom-domain-for-your-github-pages-site/about-custom-domains-and-github-pages) it as well.
