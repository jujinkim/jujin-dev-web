...
- `obsidian_watch.sh` listens for vault changes (requires `inotifywait`) and triggers manual sync after a 120 s debounce (60 s for `publish: true`).
...
- Dedicated content-writing and translation agent; instructions in `AGY.md`.
